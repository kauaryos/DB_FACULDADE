...
ALTER TABLE departamento
    MODIFY nome_departamento VARCHAR(255);  -- Alteração na coluna nome_departamento
...
ALTER TABLE professor
    ...
    MODIFY status BOOLEAN;  -- Mantenha as alterações existentes
...
ALTER TABLE disciplina
    ...
    MODIFY fk_cod_departamento INTEGER(4) NOT NULL;  -- Mantenha as alterações existentes

-- Alterações na tabela telefone
ALTER TABLE telefone
    MODIFY cod_telefone INTEGER(4) AUTO_INCREMENT,
    MODIFY numero_telefone CHAR(20);  -- Mantenha as alterações existentes
...
ALTER TABLE endereco
    ...
    MODIFY fk_cod_tipo_logradouro INT(4) NOT NULL;  -- Mantenha as alterações existentes

-- Alterações na tabela aluno
ALTER TABLE aluno
    MODIFY RA INT(4) AUTO_INCREMENT,
    MODIFY CPF BIGINT;  -- Adicione a alteração para a coluna CPF

-- Alterações na tabela historico
ALTER TABLE historico
    MODIFY cod_historico INT(4) AUTO_INCREMENT,
    MODIFY fk_RA INT(4) NOT NULL;  -- Mantenha as alterações existentes

-- Alterações na tabela professor_disciplina
ALTER TABLE professor_disciplina
    MODIFY fk_cod_professor INT(4) NOT NULL,
    MODIFY fk_cod_disciplina INT(4) NOT NULL;  -- Mantenha as alterações existentes
...
ALTER TABLE disciplina_historico
    ...
    MODIFY fk_cod_historico INT(4) NOT NULL;  -- Mantenha as alterações existentes
